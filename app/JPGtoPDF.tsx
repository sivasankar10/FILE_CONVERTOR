...
type JPGtoPDFNavigationProp = NavigationProp<RootStackParamList, 'PPDownload'>;

const JPGtoPDF: React.FC = () => {
  const navigation = useNavigation<JPGtoPDFNavigationProp>();
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        navigation.navigate('PPDownload', { data });
      } else {
