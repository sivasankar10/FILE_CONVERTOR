...
type PPDownloadRouteProp = RouteProp<RootStackParamList, 'PPDownload'>;

const PPDownload: React.FC = () => {
  const route = useRoute<PPDownloadRouteProp>();
